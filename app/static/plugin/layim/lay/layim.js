...
xxim.getGroups = function(param){
    ...
    window.xxim=xxim;
    window.writeChat=function(content){
...
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main">'
            ...
            +'<li class="xxim_online" id="xxim_online">'
                ...
                +'</div>'
            +'</li>'
            +'<li id="chat-new" class="xxim_mymsg" id="xxim_mymsg" title="我的私信"><i></i><a href="'+ config.msgurl +'"></a></li>'
